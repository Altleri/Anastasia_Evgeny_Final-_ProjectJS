...
deleteContact();//Call function that delete any specified contact
showInfoContact();//Call function that show information about contact
editContact();//Call function that allows you to edit a contact
addNewContactToArray();//Call function that created new contact
hidePopupByClickOnClose();//Call function that close all popup window by click on X
